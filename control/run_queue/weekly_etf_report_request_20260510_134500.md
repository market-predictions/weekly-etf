...
requested_at_utc: 2026-05-10T13:45:00Z
...
- Price Replacement Duel Table target symbols before lane-discovery challengers.
- Use --max-symbols 24 for challenger pricing.
- Do not stop on unresolved cached price rows; continue to fallback sources.
- Use the decision-grade replacement duel pricing contract: hard fail only for missing current holding closes or incomplete-pricing rows that appear actionable/fundable; otherwise emit warnings.
