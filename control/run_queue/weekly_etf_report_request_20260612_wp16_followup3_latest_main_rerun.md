...
reason: WP16-FOLLOWUP3 rerun from latest main after validator and test updates
...
- no visible wp16-nl-equity-curve-guard text in Markdown HTML or PDF
- English regime memory remains English
- Dutch regime memory is localized
