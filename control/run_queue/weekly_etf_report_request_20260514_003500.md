...
requested_at_utc: 2026-05-14T00:35:00Z
...
## Purpose
This run validates the broadened Dutch table/section mapping fix after the previous run failed in the Dutch client-language scrub phase on residual `THIS WEEK` wording.
...
`runtime/nl_table_section_mappings.py` now normalizes the full category of English time/run phrases in Dutch output, including:

- this week / This week / THIS WEEK
- this week's / this week’s
- next week / last week
- this run / next run / last run

## Hard Dutch-language requirements
- No English time labels such as THIS WEEK, This Week, this week, NEXT WEEK, next week, LAST WEEK, last week in the Dutch report.
