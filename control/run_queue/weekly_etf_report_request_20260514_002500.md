...
requested_at_utc: 2026-05-14T00:25:00Z
...
## Purpose
This run validates the broader centralized Dutch section/table mapping fix after the previous run failed in the Dutch client-language scrub phase.
...
`runtime/nl_table_section_mappings.py` was broadened after the previous scrub failure to cover the full category of residual English table/section terms, including:
...
- No residual section/table terms such as AI compute infrastructure, Capital spending, Neetable, SPY plus SMH creates, Structural case is credible, THIS WEEK, US equities or not promoted this week.
...
1. Dutch client-language scrub output,
