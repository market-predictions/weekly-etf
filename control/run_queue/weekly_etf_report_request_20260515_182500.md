...
requested_at_utc: 2026-05-15T18:25:00Z
...
## Validation focus
- Validate the latest `runtime/client_facing_sanitizer.py` layout fix for the hero/summary cards.
- The Kernconclusie / Main takeaway card must stay visually contained in its card.
- The old duplicated Section 1 executive summary panel must not appear as a stray large sentence below the hero cards.
