...
requested_at_utc: 2026-05-16T00:45:00Z
...
## Validation focus
- Validate `tools/validate_etf_delivery_html_contract.py` commit `62b7a9ff6c2c0124675c1103b3a07e4b3387b839`, which routes delivery HTML validation through `send_report_runtime_html.py` instead of bypassing the runtime delivery patch.
- Validate `send_report_runtime_html.py` commit `0b019824aa138dd2aa31e62ef6741699bea539ce`, which stops rendering duplicate Section 1 / executive summary at the source.
