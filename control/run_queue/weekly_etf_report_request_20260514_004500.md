...
requested_at_utc: 2026-05-14T00:45:00Z
...
## Purpose
This run validates the final Dutch PDF-audit cleanup pass after the previous run reached the Dutch language quality validator and failed on residual English / low-quality tokens.
...
Added and wired `runtime/scrub_nl_pdf_audit_leaks.py` before Dutch language quality validation. This final cleanup pass targets residual English / low-quality phrases caught by the PDF-audit validator, including:
...
- No residual PDF-audit terms such as Core U.S. large-cap exposure, Cyber spend, Direct replacement duel, Grid buildout, Growth engine, Hedge ballast, Investable maar, Needs supply-chain, SMH remains, Useful only if, Volglijst only or Zero allocation.
