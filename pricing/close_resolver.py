...
from .clients import twelve_data, fmp, alpha_vantage, issuer_pages, yahoo_history
...
class CloseResolver:
    ...
    def _fetch_from_source(self, source: str, req: PriceRequest) -> PriceResult:
        if source == "issuer_override":
            ...
            return issuer_pages.fetch_close(req.symbol, req.requested_close_date, handler)
    ...
    def resolve(self, req: PriceRequest) -> PriceResult:
        ...
        return PriceResult(req.symbol, req.requested_close_date, None, None, None, None, None, None, "unresolved", "low", error="All configured sources unresolved")
